...
public class Apce {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedReader reader = new BufferedReader(new FileReader("/Users/ann-s/OneDrive - USherbrooke/S3_Ete_2025/IFT287/Projet/ift287-main/ift287-main/code/TP/src/transactions.txt"));
            String ligne;
